...
Cell.fn.getOffset = function () {
  return this._getProperty('offsetLeft')
}
...
Cell.fn.getWidth = function () {
  return this._getProperty('clientWidth')
}

/**
 * Return a cell element's property in percentage.
 *
 * @method
 * @param {String} prop
 * @return {Number} value
...
Cell.fn._getProperty = function (prop) {
  var containerWidth = this.el.parentNode.clientWidth
  return (this.el[prop] / containerWidth) * 100
}
